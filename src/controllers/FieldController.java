...
public class FieldController {
	...
	gameFields[1] = new Street("Rødovrevej", "blå", "koster 1200", 1, 1200, 600, new int[] {50, 100, 250, 750, 2250, 4000, 6000},1000);
	gameFields[2] = new Chance("Prøv Lykken", "Træk et kort", "", 2);
	gameFields[3] = new Street("Hvidovrevej", "blå", "koster 1200", 3, 1200, 600, new int[] {50, 100, 250, 750, 2250, 4000, 6000},1000);
	gameFields[4] = new Tax("Statsskat", "Betal kr. 4000 eller 10% af din formue", "", 4);
	...
	gameFields[10] = new Visit("På besøg i fængslet", "Du har helle her", "", 10);
	...
	gameFields[16] = new Street("Bernstorffsvej", "Grå", "koster 3600", 16, 3600, 1800, new int [] {300, 600, 1400, 4000, 11000, 15000, 18000}, 2000);
	gameFields[17] = new Chance("Prøv Lykken", "Træk et kort", "", 17);
	gameFields[18] = new Street("Hellerupvej", "Grå", "koster 3600", 18, 3600, 1800, new int [] {300, 600, 1400, 4000, 11000, 15000, 18000}, 2000);
	gameFields[19] = new Street("Strandvejen", "Grå", "koster 4000", 19, 4000, 2000, new int [] {350, 700, 1600, 4400, 12000, 16000, 20000}, 2000);
	gameFields[20] = new Bonus("Bonusfelt", "Modtag kr. 5000", "", 20);
	gameFields[21] = new Street("Trianglen", "Rød", "koster 4400", 21, 4400, 2200, new int [] {350, 700, 1800, 5000, 14000, 17500, 21000}, 3000);
	gameFields[22] = new Chance("Prøv Lykken", "Træk et kort", "", 22);
	gameFields[23] = new Street("Østerbrogade", "Rød", "koster 4400", 23, 4400, 2200, new int [] {350, 700, 1800, 5000, 14000, 17500, 21000}, 3000);
	gameFields[24] = new Street("Grønningen", "Rød", "koster 4800", 24, 4800, 2400, new int [] {400, 800, 2000, 6000, 15000, 18500, 22000}, 3000);
	...
	gameFields[29] = new Street("Østergade", "Hvid", "koster 5600", 29, 5600, 2800, new int [] {500, 1000, 2400, 7200, 17000, 20500, 24000}, 3000);
	...
	gameFields[38] = new Tax("Statsskat", "Betal kr. 4000 eller 10% af din formue", "", 38);
	gameFields[39] = new Street("Rådhuspladsen", "Lilla", "koster 8000", 39, 8000, 4000, new int [] {1000, 2000, 4000, 12000, 28000, 34000, 40000},4000);
