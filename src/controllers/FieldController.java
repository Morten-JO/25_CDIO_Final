...
public class FieldController {
	...
	private void addFields(){
		...
		gameFields[9] = new Street("Allégade", "orange", "koster 2400", 9, 2400, 1200, new int [] {150, 300, 800,2000,6000,9000,12000}, 1000, 1);
		gameFields[10] = new VisitJail("På besøg i fængslet", "Du har helle her", "", 10);
		gameFields[11] = new Street("Frederiksberg Allé", "green", "koster 2800", 11, 2800, 1400, new int [] {200, 400, 1000,3000,9000,12500,15000}, 2000, 2);
		gameFields[12] = new Brewery("Squash", "Tag en Squash", "", 12, 3000, 1500,  new int[] {100,200});
		gameFields[13] = new Street("Bülowsvej", "green", "koster 2800", 13, 2800, 1400, new int [] {200, 400, 1000,3000,9000,12500,15000}, 2000, 2);
		...
		gameFields[23] = new Street("Østerbrogade", "red", "koster 4400", 23, 4400, 2200, new int [] {350, 700, 1800, 5000, 14000, 17500, 21000}, 3000, 4);
		gameFields[24] = new Street("Grønningen", "red", "koster 4800", 24, 4800, 2400, new int [] {400, 800, 2000, 6000, 15000, 18500, 22000}, 3000, 4);
		...
		gameFields[29] = new Street("Østergade", "white", "koster 5600", 29, 5600, 2800, new int [] {500, 1000, 2400, 7200, 17000, 20500, 24000}, 3000, 5);
		...
		gameFields[39] = new Street("Rådhuspladsen", "pink", "koster 8000", 39, 8000, 4000, new int [] {1000, 2000, 4000, 12000, 28000, 34000, 40000},4000, 7);
		}
