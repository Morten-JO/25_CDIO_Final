...
public class FieldController {
	...
	private void addFields(){
		...
		gameFields[1] = new Street("Rødovrevej", "blue", "koster 1200", 1, 1200, 600, new int[] {50, 100, 250, 750, 2250, 4000, 6000},1000);
		gameFields[2] = new Chance("Prøv Lykken", "Træk et kort", "", 2);
		gameFields[3] = new Street("Hvidovrevej", "blue", "koster 1200", 3, 1200, 600, new int[] {50, 100, 250, 750, 2250, 4000, 6000},1000);
		...
		gameFields[18] = new Street("Hellerupvej", "gray", "koster 3600", 18, 3600, 1800, new int [] {300, 600, 1400, 4000, 11000, 15000, 18000}, 2000);
		gameFields[19] = new Street("Strandvejen", "gray", "koster 4000", 19, 4000, 2000, new int [] {350, 700, 1600, 4400, 12000, 16000, 20000}, 2000);
		gameFields[20] = new Bonus("Bonusfelt", "Modtag kr. 5000", "", 20, 5000);
		gameFields[21] = new Street("Trianglen", "red", "koster 4400", 21, 4400, 2200, new int [] {350, 700, 1800, 5000, 14000, 17500, 21000}, 3000);
		gameFields[22] = new Chance("Prøv Lykken", "Træk et kort", "", 22);
		gameFields[23] = new Street("Østerbrogade", "red", "koster 4400", 23, 4400, 2200, new int [] {350, 700, 1800, 5000, 14000, 17500, 21000}, 3000);
		gameFields[24] = new Street("Grønningen", "red", "koster 4800", 24, 4800, 2400, new int [] {400, 800, 2000, 6000, 15000, 18500, 22000}, 3000);
		gameFields[25] = new Fleet("Gedser-Rostock", "Rederi", "Koster kr. 4000", 25, 4000, 2000, new int[]{500,1000,2000,4000});
		gameFields[26] = new Street("Bredgade", "white", "koster 5200", 26, 5200, 2600, new int [] {450, 900, 2200, 6600, 16000, 19500, 23000}, 3000);
		gameFields[27] = new Street("Kgs. Nytorv", "white", "koster 5200", 27, 5200, 2600, new int [] {450, 900, 2200, 6600, 16000, 19500, 23000}, 3000);
		gameFields[28] = new Brewery("Coca-Cola", "Tag en Cola", "", 28, 3000, 1500,  new int[] {100,200});
		gameFields[29] = new Street("Østergade", "white", "koster 5600", 29, 5600, 2800, new int [] {500, 1000, 2400, 7200, 17000, 20500, 24000}, 3000);
		gameFields[30] = new Jail("Gå i Fængsel", "Du ryger i fængsel", "", 30);
		gameFields[31] = new Street("Amagertorv", "yellow", "koster 6000", 31, 6000, 3000, new int [] {550, 1100, 2600, 7800, 18000, 22000, 25000},4000);
		gameFields[32] = new Street("Vimmelskaftet", "yellow", "koster 6000", 32, 6000, 3000, new int [] {550, 1100, 2600, 7800, 18000, 22000, 25000},4000);
